...
// Get Y2K-style icon for theme (inspired by Y2K icon pack)
function getThemeIcon(themeName) {
    const icons = {
        'Bratz Vibes': '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 2l3 9 9 1-7 6 2 9-7-5-7 5 2-9-7-6 9-1z" fill="none" stroke-linejoin="round"/><circle cx="12" cy="12" r="1.5" fill="currentColor"/><circle cx="6" cy="8" r="0.8" fill="currentColor"/><circle cx="18" cy="8" r="0.8" fill="currentColor"/><circle cx="8" cy="16" r="0.8" fill="currentColor"/><circle cx="16" cy="16" r="0.8" fill="currentColor"/></svg>',
        'Lipgloss Queen': '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="9" fill="none"/><circle cx="12" cy="12" r="6" fill="none"/><circle cx="12" cy="12" r="2" fill="currentColor"/><path d="M12 3v2M12 19v2M3 12h2M19 12h2" stroke-linecap="round"/><circle cx="6" cy="8" r="0.8" fill="currentColor"/><circle cx="18" cy="8" r="0.8" fill="currentColor"/><circle cx="8" cy="16" r="0.8" fill="currentColor"/><circle cx="16" cy="16" r="0.8" fill="currentColor"/></svg>',
        'Butterfly Clip Energy': '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><ellipse cx="8" cy="12" rx="4" ry="6" fill="none"/><ellipse cx="16" cy="12" rx="4" ry="6" fill="none"/><circle cx="6" cy="10" r="0.8" fill="currentColor"/><circle cx="18" cy="10" r="0.8" fill="currentColor"/><circle cx="6" cy="14" r="0.8" fill="currentColor"/><circle cx="18" cy="14" r="0.8" fill="currentColor"/><path d="M12 2v4M12 18v4" stroke-linecap="round"/></svg>',
        '90s Makeup Mood': '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="4" y="4" width="16" height="16" rx="2" fill="none"/><path d="M4 10h16M10 4v16" stroke-linecap="round"/><circle cx="8" cy="8" r="1" fill="currentColor"/><circle cx="16" cy="8" r="1" fill="currentColor"/><circle cx="8" cy="16" r="1" fill="currentColor"/><circle cx="16" cy="16" r="1" fill="currentColor"/><circle cx="12" cy="12" r="1" fill="currentColor"/></svg>',
        'Spice Girls Style': '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 2l2 6 6 1-4 4 1 6-5-3-5 3 1-6-4-4 6-1z" fill="none" stroke-linejoin="round"/><circle cx="12" cy="12" r="1.5" fill="currentColor"/><circle cx="6" cy="6" r="0.8" fill="currentColor"/><circle cx="18" cy="6" r="0.8" fill="currentColor"/><circle cx="6" cy="18" r="0.8" fill="currentColor"/><circle cx="18" cy="18" r="0.8" fill="currentColor"/></svg>',
        'Clueless Chic': '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="6" height="6" fill="none"/><rect x="15" y="3" width="6" height="6" fill="none"/><rect x="3" y="15" width="6" height="6" fill="none"/><rect x="15" y="15" width="6" height="6" fill="none"/><rect x="9" y="9" width="6" height="6" fill="none"/><circle cx="6" cy="6" r="0.8" fill="currentColor"/><circle cx="18" cy="6" r="0.8" fill="currentColor"/><circle cx="6" cy="18" r="0.8" fill="currentColor"/><circle cx="18" cy="18" r="0.8" fill="currentColor"/><circle cx="12" cy="12" r="0.8" fill="currentColor"/></svg>',
        'Y2K Party': '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="9" fill="none"/><circle cx="12" cy="12" r="1.5" fill="currentColor"/><circle cx="6" cy="8" r="1" fill="currentColor"/><circle cx="18" cy="8" r="1" fill="currentColor"/><circle cx="8" cy="16" r="1" fill="currentColor"/><circle cx="16" cy="16" r="1" fill="currentColor"/><circle cx="12" cy="5" r="0.8" fill="currentColor"/><circle cx="12" cy="19" r="0.8" fill="currentColor"/><circle cx="5" cy="12" r="0.8" fill="currentColor"/><circle cx="19" cy="12" r="0.8" fill="currentColor"/><path d="M8 8l8 8M16 8l-8 8" stroke-linecap="round"/></svg>',
        'Glitter & Glam': '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 2l1 4 4 1-1 4 4 1-4 1-1 4-1-4-4-1 4-1 1-4-4-1-1-4z" fill="none" stroke-linejoin="round"/><circle cx="12" cy="12" r="1.5" fill="currentColor"/><circle cx="6" cy="6" r="0.8" fill="currentColor"/><circle cx="18" cy="6" r="0.8" fill="currentColor"/><circle cx="6" cy="18" r="0.8" fill="currentColor"/><circle cx="18" cy="18" r="0.8" fill="currentColor"/></svg>'
    };
    
    // Return Y2K default icon (multi-pointed star with sparkles)
    return icons[themeName] || '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 2l2 6 6 1-4 4 1 6-5-3-5 3 1-6-4-4 6-1z" fill="none" stroke-linejoin="round"/><circle cx="12" cy="12" r="1.5" fill="currentColor"/><circle cx="6" cy="8" r="0.8" fill="currentColor"/><circle cx="18" cy="8" r="0.8" fill="currentColor"/><circle cx="8" cy="16" r="0.8" fill="currentColor"/><circle cx="16" cy="16" r="0.8" fill="currentColor"/></svg>';
}
